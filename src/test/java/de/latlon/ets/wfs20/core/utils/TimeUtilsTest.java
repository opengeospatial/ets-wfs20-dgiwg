...
public class TimeUtilsTest {
    ...
    @Test
    public void testCalculateDateRange_OneValue()
                    throws Exception {
    ...
    @Test
    public void testCalculateDateRange_Empty()
                    throws Exception {
    ...
    @Test
    public void testCalculatValueBetween()
                    throws Exception {
    ...
    @Test
    public void testCalculatValueBetween_minMaxEqual()
                    throws Exception {
