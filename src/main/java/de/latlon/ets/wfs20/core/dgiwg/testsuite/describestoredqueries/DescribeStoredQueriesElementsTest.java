...
/**
 * Tests if the StoredQueryDescribtion nodes from DescribeStoredQueries response contains
...
public class DescribeStoredQueriesElementsTest extends WfsBaseFixture {
	...
	public Object[][] parseStoredQueryDescriptionNodes(ITestContext testContext)
		...
		initRequestEntity(
				getClass().getResourceAsStream("/org/opengis/cite/iso19142/simple/DescribeStoredQueries.xml"));
	...
	@Test(description = "DGIWG - Web Feature Service 2.0 Profile, 7.2.1., S.22, Requirement 6",
			dataProvider = "storedQueryDescriptionNodes")
	public void describeStoredQueriesStoredQueriesDesriptionElementsExists(ProtocolBinding protocolBinding,
			Node storedQueryDescriptionNode, String id) {
