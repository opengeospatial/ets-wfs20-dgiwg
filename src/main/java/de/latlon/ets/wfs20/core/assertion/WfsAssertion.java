...
public final class WfsAssertion {
	 ...
	 * 'WMS_Capabilities' in namespace {http://www.opengis.net/wfs}.
	 * @param doc A Document node having {http://www.opengis.net/wfs}
	 * {@value WFS2#WFS_CAPABILITIES} as the root element.
	 */
	 ...
	 * @param response The capabilities response.
	 */
