...
public final class TimeUtils {
     ...
     * 
     * @param dateValues
     *            a list of dates, never <code>null</code>
     * @return the min and max value from the list ([0]= min , [1]=max). If the values list contains only one entry, min
     *         and max are equal. An empty array if the values list is empty.
     */
     ...
     * 
     * @param range
     *            must contain exactly two values ([0]= min , [1]=max), min and may may be equal, never
     *            <code>null</code>
     * @return a value in the range, if min == max this value is returned, never <code>null</code>
     */
     ...
     *            min datetime, never <code>null</code>
     * @param maxTimeInMillis
     *            max dateTime, never <code>null</code>
