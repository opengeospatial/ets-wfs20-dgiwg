...
public class GetCapabilitiesFeatureTypeElementsTest extends WfsBaseFixture {
	...
	@Test(description = "DGIWG - Web Feature Service 2.0 Profile, 7.2.1., S.20, Requirement 5",
			dataProvider = "featureTypeNodes")
	public void wfsCapabilitiesFeatureTypeElementsExists(ProtocolBinding protocolBinding, Node featureTypeNode,
			String name) {
