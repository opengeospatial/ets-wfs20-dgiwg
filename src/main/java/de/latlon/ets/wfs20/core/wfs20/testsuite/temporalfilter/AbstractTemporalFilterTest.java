...
public abstract class AbstractTemporalFilterTest extends QueryFilterFixture {
    ...
    protected
                    Iterator<Object[]>
                    createDataProviderWithProtocolsFeatureTypesAndTemporalOperators( List<String> expectedTemporalOperators )
    ...
    protected List<String>
                    parseExpectedTemporalOperators( Document wfsMetadata, List<String> expectedTemporalOperators )
                                    throws XPathFactoryConfigurationException, XPathExpressionException {
    ...
    /**
     * Encapsulates the FeatureType a date property of the feature type and the value range. None of them must be
     * <code>null</code>!
     * 
     * @author <a href="mailto:goltz@lat-lon.de">Lyn Goltz</a>
     */
